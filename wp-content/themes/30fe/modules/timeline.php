<section id="timeline" class="about__timeline">
  ...
  <div class="body-wrap">
    ...
    <div class="pres-timeline" id="this-timeline">
      ...
      <div class="periods-container" style="display:none">
        ...
        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Laudantium doloremque, laboriosam officia facere
      ...
      <div class="cards-container">
        <section class="card-single active" period="period1">
          ...
          <div class="content">
            ...
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Tempore vitae sint dolore, officia esse! A
              recusandae nemo illum rem eos iusto repellendus, voluptatibus tempora nulla voluptatem officia inventore
              ea
              modi.</p>
          </div>
        </section>
        ...
        <section class="card-single" period="period1">
          ...
          <h2 class="title">Lorem ipsum dolor sit amet.</h2>
          <div class="content">
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. A tempora blanditiis ut voluptas nisi labore
              quos
              iste totam obcaecati modi rerum iusto, voluptate odio commodi ratione amet illum dicta accusamus, ipsum ea
