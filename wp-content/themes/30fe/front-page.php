...
<main class="main-container">
            ...
            <section class="max-width home__hero__padding-top">
                ...
                <section class="wrapper">
                    <aside class="aside aside-1">
                        <h1 id="banner-text" class="home__banner__headline"> Precision&nbsp;in <br>Investigation,
                            <br>Clarity
                            in <br>Solutions.
                        </h1>
                    ...
                    <aside class="aside aside-2">
                        <article class="home__hero__wrapper">
                            <section class="home__hero__container">
                                <p class="home__hero__text">We are a team of investigators, engineers, scientists, and
                                    problem solvers.
                                    We&nbsp;bring clarity to complex scientific problems to help our clients make
                                    decisions with
                                    confidence. All our work is backed by uncompromising investigative forensic
                                    reporting.
                                    <br><br>
                                ...
                                <img class="home__hero__image"
                                    src="<?php echo get_template_directory_uri(); ?>/images/banner.gif" alt="">
                            </section>
                            <section class="home__hero__buttons">
                                &nbsp;
                            </section>
        ...
        <section id="hero--mobile">
            ...
            <section class="max-width home__hero__padding-bottom">
                ...
                <article class="home__hero__wrapper">
                    ...
                    <p class="home__hero__text--mobile">We are a team of investigators, engineers, scientists and
                        problem solvers.
    ...
    <section id="accordion-scroll" class="fullscreen">
        ...
        ?>
                <div
                    class="accordion__item <?php if(get_row_index() === 1) echo 'active' ?> <?php    echo $colors[$k] ?>">
                    ...
                    <section class="accordion__body active">
                        <section class="accordion__wrapper">
                            ...
                            <img loading="lazy" class="accordion__image" src="<?php echo $image ?>"
          ...
          ?>
                ...
                <div
                    ...
                    <div class="accordion-mobile__body content">
                        ...
                        <img loading="lazy" class="accordion-mobile__image" src="<?php echo $image ?>"
                            alt="<?php echo $alt; ?>" title="<?php echo $alt; ?>">
        ...
        <section class="max-width max-padding">
            ...
            <section class="quote__buttons">
                <a href="<?php echo site_url('/expertise')?>" target="_self"><button class="home__hero__button">Browse
                        Expertise</button></a>
                <a href="<?php echo site_url('/sectors')?>"><button
                        class="home__hero__button home__hero__button--white">Browse
                        Sectors</button></a>
            </section>
        </section>
    </section>
            ...
            <div id="statsBar" class="stats__background">
                <div class="stats__progress-wrap" style="opacity: 0.9, width: 0;">
                    <div class="stats__progress black-bg">
                        <section>
                            ...
                            <div id="label-1" class="stats__label stats__label-orange orange-bg">Cases Investigated
                            </div>
                        </section>
                ...
                <div class="stats__progress-wrap" style="opacity: 0.9, width: 0;">
                    <div class="stats__progress black-bg">
                        ...
                        <div id="label-2" class="stats__label stats__label-green green-bg">Engineers and Scientists
                        </div>
                    </div>
                </div>
                <div class="stats__progress-wrap" style="opacity: 0.9, width: 0;">
                    <div class="stats__progress black-bg">
                        ...
                        <div id="label-3" class="stats__label stats__label-blue blue-bg">Project and Operational
                            Specialists</div>
                    </div>
                </div>
                <div class="stats__progress-wrap" style="opacity: 0.9, width: 0;">
    ...
    <section class="insights fullscreen">
        <section class="max-width max-padding">
            <section class="home__insights__section">
                ...
                <a href="<?php echo site_url('/insights')?>"><button class="home__insights__button">View
                        All</button></a>
