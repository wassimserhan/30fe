  ...
  <section class="contact">
    ...
    <section class="contact__locations fullscreen">
      ...
      <article class="contact__location">
        ...
        <h2 id="showVA" class="contact__location__city" style="color:#08cb80 ">Vancouver</h2>
        <a
      ...
      <article class="contact__location">
        ...
        <h2 id="showOT" class="contact__location__city" style="color: #0175df">Ottawa</h2>
        <a
      ...
      <article class="contact__location">
        ...
        <h2 id="showCA" class="contact__location__city" style="color: #cbbea5">Calgary</h2>
        <a
