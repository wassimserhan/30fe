        ...
        <section class="max-width max-padding max-padding--top">
            ...
            <img src="<?php echo get_template_directory_uri(); ?>/images/maps/vancouver.svg" /> -->
                    ...
                    <picture id="ottawa" class="map-image">
                        ...
                        <img src="<?php echo get_template_directory_uri(); ?>/images/maps/Ottawa_Desktop.svg"
                            alt="Map of Ottawa">
                    ...
                    <section class="contact__locations">
                        <article class="contact__location">
                            ...
                            <a href="https://www.google.com/maps/place/555+Burrard+St,+Vancouver,+BC+V7X+1M8/@49.2863716,-123.1212611,17z/data=!3m1!4b1!4m5!3m4!1s0x548671822d969bd9:0x3899cbe47e0fa337!8m2!3d49.2863681!4d-123.1190724?shorturl=1"
                                target="_blank">
                                <p>555 Burrard Street <br>16th Floor, Suite 102<br>
        ...
        <section class="contact__information max-width">
            ...
            <section class="contact__details max-padding">
                ...
                <ul class="contact__detail">
                    <li> <img class="contact__details__icon"
                            src="<?php echo get_template_directory_uri(); ?>/images/Phone.svg" width="25" height="25"
                            alt="Phone icon"> <a href="tel:1-800-564-5313">1 (800) 564-5313</a></li>
                    <li><img class="contact__details__icon"
                            src="<?php echo get_template_directory_uri(); ?>/images/Email.svg" width="25" height="25"
                            alt="Email icon"> <a href="mailto:info@30fe.com">info@30fe.com</a></li>
                    <li><img class="contact__details__icon"
                            src="<?php echo get_template_directory_uri(); ?>/images/Twitter.svg" width="25" height="25"
                            alt="Twitter icon"> <a href="https://twitter.com/30Forensics">@30Forensics</a>
                    </li>
                    <li> <img class="contact__details__icon"
                            src="<?php echo get_template_directory_uri(); ?>/images/LinkedIn.svg" width="25" height="25"
                            alt="LinkedIn icon"> <a href="https://ca.linkedin.com/company/-30-forensic-engineering">-30-
                            Forensic
                            Engineering</a></li>
                </ul>
                ...
                <section class="contact__details__press">
                    ...
                    <p>If you are a member of the press and would like to connect with our experts or learn more about
                        our work,
                        please contact:
                        <br><br>
                        Paul Aquino <br>
                    ...
                    <br>
                    <br>
                    <p>30FE arranges for accessible feedback, accessible formats, and communication supports, on
                        request.</p>
                </section>
            </section>
        </section>
